const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      "assets/index-pH-YNvKv.js",
      "assets/index-CJq82H83.js",
      "assets/index-BzGgqTIF.css",
    ])
) => i.map((i) => d[i]);
import { _ as fe } from "./index-CJq82H83.js";
const me = Symbol(),
  ...
  be = (
    ...
    c = (n, h, I = r) => {
      ...
      return (
        te(v, !0),
        l.set(n, [h, v]),
        Reflect.ownKeys(n).forEach((P) => {
          if (Object.getOwnPropertyDescriptor(v, P)) return;
          const E = Reflect.get(n, P),
    ...
    W = (n) => {
      ...
      return (
        ...
        Reflect.ownKeys(n).forEach((i) => {
          ...
          "value" in a && (($[i] = n[i]), delete a.value, delete a.writable),
            Object.defineProperty(J, i, a);
        }),
        $
      );
    }
...
const d = j({
  ...
  Ie = {
    state: u,
    subscribe(e) {
      return S(u.events, () => e(ve(u.events[u.events.length - 1])));
    },
    initialize() {
      u.enabled &&
...
const T = j({ themeMode: _e() ? "dark" : "light" }),
  ce = {
    ...
    setThemeConfig(e) {
      ...
      t && (T.themeMode = t), s && (T.themeVariables = Pe({}, s));
    },
  },
...
class ke {
  ...
  async initUi() {
    if (typeof window < "u") {
      await fe(() => import("./index-pH-YNvKv.js"), __vite__mapDeps([0, 1, 2]));
